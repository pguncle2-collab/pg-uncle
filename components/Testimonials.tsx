  ...
  const testimonials: Testimonial[] = [
    {
      ...
      avatar: 'https://media.gettyimages.com/id/1311934969/photo/hands-typing-on-laptop-with-virtual-real-estate-icons-showing-approved-houses-and-checklist.jpg',
      rating: 5,
    },
    {
      name: 'Rohan Verma',
