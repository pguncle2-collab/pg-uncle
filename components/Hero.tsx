      ...
      <div className="container mx-auto px-5 md:px-6 relative z-10 py-20 lg:py-32">
        <div className="max-w-5xl animate-fade-in">
          ...
          <h1 className="text-2xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Your Trusted Uncle for a Comfortable <span className="text-blue-400">PG Stay</span> in <span className="text-blue-400">Chandigarh Tricity</span>
          </h1>
          <p className="text-sm md:text-xl lg:text-2xl text-gray-200 mb-8 leading-relaxed">
